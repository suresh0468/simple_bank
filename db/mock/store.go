...
// Source: github.com/suresh/simple_bank/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) DeleteEntry(ctx context.Context, id sql.NullInt64) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetEntry(ctx context.Context, id sql.NullInt64) (db.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTransfer(ctx context.Context, id sql.NullInt64) (db.Transfer, error) {
	m.ctrl.T.Helper()
