...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto2\xeb\x02\n" +
	"\n" +
	...
	"Login user\x1aQUse this API to authenticate a user and obtain an access token and refresh token.\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/users/loginBz\x92AU\x12S\n" +
	"\x0fSimple Bank API\";\n" +
